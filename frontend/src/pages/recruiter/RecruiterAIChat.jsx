...
export default function CandidateAIChat() {
  ...
  return (
    <RecruiterLayout title="AI Hiring Assistant" breadcrumbs={[{ label: "AI Assistant" }]}>
      <PageHeader
        title="🤖 AI Hiring Assistant"
        subtitle="Chat with AI to analyze candidates"
      />
      ...
      <div className="border rounded-lg h-[550px] overflow-y-auto p-6 bg-gray-50">
        {(history || []).map((chat, index) => (
          ...
          >
            <div
              className={`inline-block max-w-[75%] px-4 py-3 rounded-lg ${chat.role === "user"
      ...
      <div className="flex mt-4 gap-3">
        ...
        <button
          onClick={sendMessage}
          disabled={loading}
          className={`px-6 rounded-lg text-white ${loading
