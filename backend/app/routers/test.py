...
def submit_test(
    ...
    total_questions = db.query(Question).filter(Question.job_id == application.job_id).count()
    correct_answers = 0
    ...
    test_percentage = (correct_answers / total_questions * 100) if total_questions > 0 else 0.0
    ...
    final_score = calculate_final_score(
        profile.skill_score, test_percentage, profile.resume_quality_score
    )

    application.test_correct_answers = correct_answers
    application.test_total_questions = total_questions
    application.test_score = test_percentage
